...
$spellcasting_ability = $char['spellcasting_ability'] ?? null;
$spell_save_dc = null;
...
if ($spellcasting_ability) {
    ...
    if (isset($ability_map[$spellcasting_ability])) {
        $ability_score = $ability_map[$spellcasting_ability];
...
<div class="flex gap-4">
    ...
    <div class="text-center">
        <p class="text-2xl font-bold text-white">+<?php echo $char['proficiency_bonus'] ?? 2; ?></p>
        <p class="text-xs text-gray-400">Proficiency</p>
    </div>
    <?php if ($spell_save_dc !== null): ?>
    <div class="text-center">
        <p class="text-2xl font-bold text-purple-400"><?php echo $spell_save_dc; ?></p>
        <p class="text-xs text-gray-400">Spell DC</p>
    </div>
    <?php endif; ?>
    <?php if ($spellcasting_ability): ?>
    <div class="text-center">
        <p class="text-2xl font-bold text-purple-400"><?php echo $spellcasting_ability; ?></p>            
        <p class="text-xs text-gray-400">Spellcasting Ability</p>
    </div>
    <?php endif; ?>
</div>
    </div>
